...
public class NotificationController(IMediator mediator) : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<GetNotificationsResponse>> GetAllAsync([FromQuery] PaginationParams @params)
    {
        var result = await mediator.Send(new GetNotificationsQuery(@params));
